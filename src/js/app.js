define(["class", "youtrack", "selection", "pubsub", "router", "util", "columns", "keys", "filter"],
    function (Class, Youtrack, Selection, Pubsub, Router, Util, Columns, Keys) {
        var App = Keys.extend({
            columns: ['Rank','id', "Reporter", 'summary', "State", "Squad", "updated", "Assignee", "Assigned QA", "Code Reviewed By", "Business Owner"],
            systemProperties: [
      "projectShortName",
      "numberInProject",
      "summary",
      ...
      "updaterFullName"],
            ...
            _initRelayout: function () {
                ...
                if (!self.layoutInitialized) {
                    ...
                    var test = $('<div/>', {
                        class: 'lengthBox',
                        style: 'display: table-cell; visibility: hidden;'
                    });
            ...
            _buildFields: function (issue) {
                var el = $("<div/>", {
                    class: "mdl-card mdl-shadow--2dp fields"
                });
