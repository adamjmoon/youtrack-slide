define(["class", "util"], function (Class, Util) {
    ...
    var State = Column.extend({
        ...
        build: function () {
            var el = $('<div></div>', {
                class: "state mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"
            });
    ...
    var Updated = Column.extend({
        ...
        build: function () {
            ...
            default:
                ...
                text = (date.getMonth() + 1) + "." + ('0' + date.getDate()).slice(-2) + "." + date.getFullYear().toString().slice(2);
                break;
            }
